...
const keyword_pool_service_1 = require("./keyword-pool.service");
...
exports.MetadataModule = MetadataModule = __decorate([
    (0, common_1.Module)({
        providers: [taxonomy_service_1.TaxonomyService, keyword_pool_service_1.KeywordPoolService],
        exports: [taxonomy_service_1.TaxonomyService, keyword_pool_service_1.KeywordPoolService],
    })
], MetadataModule);
