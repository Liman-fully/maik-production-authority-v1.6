...
export function Navigation() {
  ...
  const menuItems: NavMenuItem[] = [
    { name: "人才广场", href: "/", icon: Users },
    { name: "简历库", href: "/resumes", icon: FileText },
        ...
        <div className="mx-auto flex h-14 max-w-[1440px] items-center justify-between px-6 lg:px-12">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold">脉刻 MAIK</span>
            </Link>
          </div>

          {/* Center: Menu - 真正居中且稳定 */}
          <nav className="absolute left-1/2 hidden -translate-x-1/2 transform md:flex">
              ...
              {menuItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    className={cn(
                      "flex flex-1 flex-col items-center gap-0.5 px-4 py-2 text-[10px] font-medium transition-colors",
                      isActive
                        ? "text-primary"
